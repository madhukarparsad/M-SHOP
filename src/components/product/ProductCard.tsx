...
//   // Quick view is not used currently

//   if (variant === 'compact') {
//     return (
//       <Link 
//         to={`/product/${product.id}`}
//         className="group block bg-white rounded-lg border border-gray-100 hover:border-[#5BA4B0] transition-all duration-300 hover:shadow-lg"
//       >
//         <div className="p-4">
...
//               <h3 className="font-medium text-[#2D3748] truncate group-hover:text-[#5BA4B0] transition-colors">
//                 {product.name}
//               </h3>
//               <p className="text-sm text-[#718096] truncate">{product.brand}</p>
//               <div className="flex items-center justify-between mt-2">
//                 <div className="flex items-center space-x-2">
//                   <Rating rating={product.rating} size="sm" />
//                   <span className="text-xs text-[#718096]">({product.reviewCount})</span>
//                 </div>
//                 <div className="text-right">
//                   {product.originalPrice && product.originalPrice > product.price && (
//                     <span className="text-sm text-[#718096] line-through mr-2">
...
//   return (
//     <div className="group bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-all duration-200 hover:border-gray-300 max-w-sm">
//       {/* Product Image */}
...
//             e.preventDefault();
//             e.stopPropagation();
//             if (!isInCompare(product.id) && compareItems.length >= 3) return; // enforce limit
//             toggleCompare(product.id);
//           }}
//           className={`absolute top-2 right-2 px-2.5 py-1 rounded-full text-xs font-medium shadow ${
...
//       <div className="p-3">
//         <Link to={`/product/${product.id}`}>
//           <h3 className="font-medium text-gray-900 text-sm line-clamp-2 mb-1 group-hover:text-sky-600 transition-colors">
//             {product.name}
//           </h3>
//         </Link>
...
//         {/* Reduce vertical space; compare button moved onto image */}
...
//             className={`inline-flex items-center justify-center py-2 px-3 rounded text-sm font-medium transition-colors ${
//               product.inStock
