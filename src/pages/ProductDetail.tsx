...
// import { ShoppingCart, Heart, Star, ChevronLeft, ChevronRight, Share2, Truck, Shield, RotateCcw } from 'lucide-react';
...
//           <h1 className="text-3xl font-bold text-[#2D3748] mb-4">Product Not Found</h1>
//           <p className="text-lg text-[#718096] mb-8">{error || 'The product you are looking for does not exist.'}</p>
//           <Link
//             to="/"
//             className="inline-flex items-center bg-[#5BA4B0] hover:bg-[#4A8A94] text-white px-8 py-4 rounded-lg font-medium text-lg shadow-lg transition-all duration-300"
//           >
...
//           {/* Breadcrumb */}
//           <nav className="mb-8">
//             <ol className="flex items-center space-x-2 text-sm text-[#718096]">
//               <li>
//                 <Link to="/" className="hover:text-[#5BA4B0] transition-colors">
//                   Home
//                 </Link>
//               </li>
//               <li className="flex items-center">
//                 <ChevronLeft className="w-4 h-4 mx-1" />
//                 <Link to={`/category/${product.category.toLowerCase().replace(/\s+/g, '-')}`} className="hover:text-[#5BA4B0] transition-colors">
//                   {product.category}
//                 </Link>
//               </li>
//               <li className="flex items-center">
...
//                         index === selectedImage
//                           ? 'border-[#5BA4B0] ring-2 ring-[#5BA4B0]/20'
//                           : 'border-gray-200 hover:border-[#5BA4B0]/50'
//                       }`}
//                     >
//                       <img
//                         src={image}
...
//                   <span className="text-sm text-[#718096]">{product.brand}</span>
//                   <div className="w-1 h-1 bg-[#718096] rounded-full"></div>
//                   <span className="text-sm text-[#718096]">{product.category}</span>
//                 </div>
                
//                 <h1 className="text-3xl font-bold text-[#2D3748] mb-4 leading-tight">
//                   {product.name}
//                 </h1>
...
//                   <span className="text-[#718096]">({product.reviewCount} reviews)</span>
//                 </div>
//               </div>
...
//                   {hasDiscount && (
//                     <>
//                       <span className="text-xl text-[#718096] line-through">
//                         {formatPrice(product.originalPrice!)}
//                       </span>
//                       <span className="bg-[#F5D547] text-[#2D3748] px-3 py-1 rounded-full text-sm font-semibold">
...
//                 {hasDiscount && (
//                   <p className="text-sm text-[#48BB78] font-medium">
//                     Limited time offer! Save {formatPrice(product.originalPrice! - product.price)} today.
//                   </p>
//                 )}
//               </div>
...
//               {/* Description */}
//               <div>
//                 <h3 className="font-semibold text-[#2D3748] mb-2">Description</h3>
//                 <p className="text-[#718096] leading-relaxed">{product.description}</p>
//               </div>

//               {/* Features */}
//               {product.features.length > 0 && (
//                 <div>
//                   <h3 className="font-semibold text-[#2D3748] mb-3">Key Features</h3>
//                   <ul className="space-y-2">
//                     {product.features.map((feature, index) => (
//                       <li key={index} className="flex items-start space-x-2">
//                         <div className="w-1.5 h-1.5 bg-[#5BA4B0] rounded-full mt-2 flex-shrink-0"></div>
...
//                   <label className="font-medium text-[#2D3748]">Quantity:</label>
...
//                           : 'border-[#5BA4B0] text-[#5BA4B0] hover:bg-[#5BA4B0] hover:text-white'
//                       }`}
//                     >
//                       <ChevronLeft className="w-4 h-4" />
//                     </button>
                    
//                     <span className="w-16 text-center font-medium text-[#2D3748]">
//                       {quantity}
//                     </span>
                    
//                     <button
//                       onClick={() => handleQuantityChange(quantity + 1)}
//                       className="w-10 h-10 rounded-lg border border-[#5BA4B0] text-[#5BA4B0] hover:bg-[#5BA4B0] hover:text-white transition-all duration-200 flex items-center justify-center"
//                     >
...
//                     className={`flex-1 py-4 px-6 rounded-lg font-medium text-lg transition-all duration-200 flex items-center justify-center space-x-2 ${
//                       product.inStock
//                         ? 'bg-[#5BA4B0] text-white hover:bg-[#4A8A94] shadow-lg transform hover:scale-[1.02]'
...
//                     className={`px-6 py-4 rounded-lg border-2 transition-all duration-200 flex items-center justify-center space-x-2 ${
//                       isWishlisted
...
//                   <div className="w-12 h-12 bg-[#48BB78]/10 rounded-full flex items-center justify-center mx-auto mb-2">
//                     <Truck className="w-6 h-6 text-[#48BB78]" />
//                   </div>
//                   <p className="text-xs text-[#718096]">Free Shipping</p>
//                 </div>
//                 <div className="text-center">
//                   <div className="w-12 h-12 bg-[#48BB78]/10 rounded-full flex items-center justify-center mx-auto mb-2">
//                     <Shield className="w-6 h-6 text-[#48BB78]" />
//                   </div>
//                   <p className="text-xs text-[#718096]">Secure Payment</p>
//                 </div>
//                 <div className="text-center">
//                   <div className="w-12 h-12 bg-[#48BB78]/10 rounded-full flex items-center justify-center mx-auto mb-2">
//                     <RotateCcw className="w-6 h-6 text-[#48BB78]" />
//                   </div>
//                   <p className="text-xs text-[#718096]">Easy Returns</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//             <div className="bg-white rounded-xl border border-gray-100 p-8 mb-16">
//               <h2 className="text-2xl font-semibold text-[#2D3748] mb-6">Specifications</h2>
...
//           {/* Related Products */}
//           <div>
//             <h2 className="text-2xl font-semibold text-[#2D3748] mb-8">You Might Also Like</h2>
