...
//             <div className="w-24 h-24 bg-[#5BA4B0]/10 rounded-full flex items-center justify-center mx-auto mb-6">
//               <ShoppingBag className="w-12 h-12 text-[#5BA4B0]" />
//             </div>
//             <h1 className="text-3xl font-bold text-[#2D3748] mb-4">Your cart is empty</h1>
...
//             <Link
//               to="/"
//               className="inline-flex items-center bg-[#5BA4B0] hover:bg-[#4A8A94] text-white px-8 py-4 rounded-lg font-medium text-lg shadow-lg transition-all duration-300 transform hover:scale-105"
//             >
//               Start Shopping
...
//           {/* Page Header */}
//           <div className="mb-8">
//             <h1 className="text-3xl font-bold text-[#2D3748] mb-2">Shopping Cart</h1>
...
//                 <button
//                   onClick={clearCart}
//                   className="inline-flex items-center px-4 py-2 text-[#718096] hover:text-red-500 hover:bg-red-50 rounded-lg transition-all duration-200"
//                 >
...
//                 <h2 className="text-xl font-semibold text-[#2D3748] mb-6">Order Summary</h2>
...
//                   <div className="flex justify-between text-[#718096]">
//                     <span>Shipping</span>
//                     <span className={shipping === 0 ? 'text-[#48BB78] font-medium' : ''}>
//                       {shipping === 0 ? 'Free' : formatPrice(shipping)}
//                     </span>
//                   </div>
                  
//                   {shipping > 0 && (
//                     <div className="text-sm text-[#48BB78] bg-[#48BB78]/10 p-3 rounded-lg">
...
//                   <div className="flex justify-between text-lg font-bold text-[#2D3748]">
//                     <span>Total</span>
...
//                 {/* Checkout Button */}
//                 <button className="w-full bg-[#5BA4B0] hover:bg-[#4A8A94] text-white py-4 px-6 rounded-lg font-medium text-lg shadow-lg transition-all duration-300 transform hover:scale-[1.02] mb-4">
//                   Proceed to Checkout
//                 </button>
...
//                 <Link
//                   to="/"
//                   className="block w-full text-center py-3 px-6 border border-[#5BA4B0] text-[#5BA4B0] rounded-lg font-medium hover:bg-[#5BA4B0] hover:text-white transition-all duration-200"
//                 >
//                   Continue Shopping
//                 </Link>
...
//                   <div className="flex items-center justify-center space-x-4 text-xs text-[#718096]">
//                     <div className="flex items-center">
//                       <div className="w-4 h-4 bg-[#48BB78] rounded-full mr-2"></div>
//                       Secure Checkout
//                     </div>
//                     <div className="flex items-center">
//                       <div className="w-4 h-4 bg-[#48BB78] rounded-full mr-2"></div>
